<template>
  <div id="FirstPage" style="height: 100%">
    <el-row style="height: 100%">
      <el-col :span="23" style="height: 100%">
        <div id="myChart33" style="height: 100%"></div>
      </el-col>
    </el-row>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      waii(){
        let myChart33 = this.$echarts.init(document.getElementById('myChart33'));
        /**
         * 获取图表属性
         * @param name select的名称
         */
        let geoCoordMap = {
          "广州第一公安局":[113.23,23.16],
          "东莞大朗公安局":[113.75,23.04],
          "汕头司法所":[114.23,24.16],
          "汕尾镇司法所":[114.75,23.88]
        };
        // let geoCoordMap= {
          ...
          series: [
            {
              ...
              data: convertData([{name:"广州第一公安局",value:"广州省天河区车陂南路启明大道36号"},{name:"东莞大朗公安局",value:"大朗镇犀牛坡223号"}]),
              symbolSize: 12,
              label: {
                normal: {
                  show: false
            ...
            },
            {
              ...
              type: 'scatter',
              coordinateSystem: 'geo',
              data: convertData([{name:"汕头司法所",value:"汕头市龙湖区华山路16号"},{name:"汕尾镇司法所",value:"汕尾市城区腾飞路3号"}]),
              symbolSize: 12,
              label: {
                normal: {
                  show: false
        ...
        myChart33.on('click', function (params) {
          if(mapID===1){
            ...
            mapID=1;
            myChart33.setOption(getChartOptions('广东'));
          }
        });
      }
    }
